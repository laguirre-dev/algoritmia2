...
def menuOpciones(legajoAlumno):
    ...
    print(
        ...
        + f"¡Bienvenido Alumno {buscar.buscarAlumnoPorLegajoNombreYApellido(legajoAlumno)} !\n"
    )
        ...
        if opcion == 1:
            ...
            while subopcion != 3:
                ...
                if subopcion == 1:
                    ...
                    idCurso = input(
                        headers.Fore.WHITE
                        + "Ingrese el ID del curso del que desea darse de baja: "
                    )
            ...
            while subopcion != 2:
                if subopcion == 1:
                    ...
                    try:
                        gestion_reportes.generarReporteDeCursosInscriptoAlumno(
                            legajoAlumno
                        )
